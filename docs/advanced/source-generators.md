...
Sculptor is built as an incremental source generator that analyzes your code at compile time and generates interceptor code. This page explains how source generators work and how Sculptor implements them.
...
## Sculptor's Generator Pipeline

Sculptor implements an incremental source generator with the following pipeline:
...
Sculptor first checks that the project uses C# 11+:
...
Sculptor uses two parallel providers to find decorated types:
...
context.RegisterSourceOutput(combined, (spc, decoratedRegistrations) =>
{
    ...
    source.AppendLine();
    source.AppendLine("file static class SculptorInterceptors");
    source.AppendLine("{");
    ...
    spc.AddSource("Sculptor.Interceptors.g.cs", source.ToString());
});
...
Sculptor uses incremental generation for performance:
...
Sculptor reports diagnostics for common errors:
...
public static class Diagnostics
{
    public static DiagnosticDescriptor MissingCSharp11 = new(
        id: "SCULPT001",
        title: "C# 11 required",
        messageFormat: "Sculptor requires C# 11 or later. Set <LangVersion>11</LangVersion> in your project file.",
        category: "Sculptor",
...
Sculptor generates clean, readable code:

```csharp
// <auto-generated/>
// Sculptor v1.0.0
// https://github.com/LayeredCraft/sculptor

using System;
using System.CodeDom.Compiler;
using Microsoft.Extensions.DependencyInjection;

[GeneratedCode("Sculptor", "1.0.0")]
