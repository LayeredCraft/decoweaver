...
namespace DecoWeaver.Generated
{
    ...
    file static class DecoWeaverInterceptors
    {
        ...
        /// <summary>Intercepted: ServiceCollectionServiceExtensions.AddScoped&lt;global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>, global::DecoWeaver.Sample.SqlRepository<DecoWeaver.Sample.Order>&gt;(IServiceCollection)</summary>
            ...
            where TImplementation : class, TService
        {
            ...
            var key = DecoratorKeys.For(typeof(global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>), typeof(global::DecoWeaver.Sample.SqlRepository<DecoWeaver.Sample.Order>));
            services.AddKeyedScoped<global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>, global::DecoWeaver.Sample.SqlRepository<DecoWeaver.Sample.Order>>(key);
            ...
            services.AddScoped<global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>>(sp =>
            {
                ...
                current = (global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>)DecoratorFactory.Create(sp, typeof(global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>), typeof(global::DecoWeaver.Sample.LoggingRepository<>), current);
                return current;
            });
            return services;
        }
