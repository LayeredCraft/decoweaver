...
namespace DecoWeaver.Generated
{
    ...
    file static class DecoWeaverInterceptors
    {
        ...
        /// <summary>Intercepted: ServiceCollectionServiceExtensions.AddScoped&lt;global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>, global::DecoWeaver.Sample.DynamoDbRepository<DecoWeaver.Sample.Order>&gt;(IServiceCollection)</summary>
            ...
            where TImplementation : class, TService
        {
            ...
            var key = DecoratorKeys.For(typeof(global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>), typeof(global::DecoWeaver.Sample.DynamoDbRepository<DecoWeaver.Sample.Order>));
            services.AddKeyedScoped<global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>, global::DecoWeaver.Sample.DynamoDbRepository<DecoWeaver.Sample.Order>>(key);

            // Register factory that applies decorators
            services.AddScoped<global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>>(sp =>
            {
                var current = (global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>)sp.GetRequiredKeyedService<global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>>(key)!;
                // Compose decorators (innermost to outermost)
                current = (global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>)DecoratorFactory.Create(sp, typeof(global::DecoWeaver.Sample.IRepository<DecoWeaver.Sample.Order>), typeof(global::DecoWeaver.Sample.CachingRepository<>), current);
                return current;
            });
            return services;
        }
