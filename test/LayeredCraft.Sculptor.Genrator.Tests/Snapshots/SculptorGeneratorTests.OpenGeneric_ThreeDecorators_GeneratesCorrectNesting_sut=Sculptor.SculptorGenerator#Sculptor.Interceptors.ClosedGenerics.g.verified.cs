...
namespace Sculptor.Generated
{
    ...
    {
        [InterceptsLocation(version: 1, data: "emld9F2TMCfA9NHorMyUPOAAAABQcm9ncmFtLmNz")]
            ...
            where TImplementation : class, TService
        {
            ...
            services.AddScoped<global::Sculptor.Sample.IRepository<Customer>>(sp =>
            {
                ...
                current = (global::Sculptor.Sample.IRepository<Customer>)DecoratorFactory.Create(sp, typeof(global::Sculptor.Sample.IRepository<Customer>), typeof(global::Sculptor.Sample.AuditRepository<>), current);
